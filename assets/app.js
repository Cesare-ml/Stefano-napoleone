...
photosCss.href='assets/photos.css?v=9';
...
if(portrait){
  ...
  portrait.innerHTML='<img src="assets/images/stefano-napoleone-ritratto.webp?v=3" alt="Stefano Napoleone, operatore Reiki e studioso di numerologia evolutiva" loading="eager" fetchpriority="high" decoding="async">';
}
...
if(energyContent){
  ...
  session.innerHTML='<img src="assets/images/stefano-napoleone-reiki-sessione.webp?v=3" alt="Stefano Napoleone durante una sessione Reiki in presenza" loading="lazy" decoding="async"><figcaption class="photo-caption">Una sessione Reiki in presenza, in uno spazio tranquillo e rispettoso.</figcaption>';
  ...
  detail.innerHTML='<img src="assets/images/stefano-napoleone-reiki-dettaglio.webp?v=3" alt="Dettaglio delle mani di Stefano durante un trattamento Reiki" loading="lazy" decoding="async"><figcaption class="photo-caption">Il contatto viene sempre adattato con delicatezza alla persona.</figcaption>';
