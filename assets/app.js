...
photosCss.href='assets/photos.css?v=32';
...
if(portrait){
  ...
  portrait.innerHTML=`
    <picture>
      <source media="(max-width: 700px)" srcset="assets/images/stefano-napoleone-ritratto-mobile.webp?v=32" type="image/webp">
      <img
        src="assets/images/stefano-napoleone-ritratto-desktop.webp?v=32"
...
if(energyContent){
  ...
  session.innerHTML=`
    <picture>
      <source media="(max-width: 700px)" srcset="assets/images/stefano-napoleone-reiki-sessione-mobile.webp?v=32" type="image/webp">
      <img
        src="assets/images/stefano-napoleone-reiki-sessione-desktop.webp?v=32"
  ...
  detail.innerHTML=`
    <picture>
      <source media="(max-width: 700px)" srcset="assets/images/stefano-napoleone-reiki-dettaglio-mobile.webp?v=32" type="image/webp">
      <img
        src="assets/images/stefano-napoleone-reiki-dettaglio-desktop.webp?v=32"
