const photosCss=document.createElement('link');photosCss.rel='stylesheet';photosCss.href='assets/photos.css?v=4';document.head.appendChild(photosCss);

const portrait=document.querySelector('.portrait-placeholder');
if(portrait){
  portrait.setAttribute('aria-label','Ritratto di Stefano Napoleone');
  portrait.innerHTML='<img src="assets/images/stefano-ritratto.jpg?v=1" alt="Stefano Napoleone, operatore Reiki e studioso di numerologia evolutiva" loading="eager" fetchpriority="high">';
}
...
if(energyContent){
  ...
  session.innerHTML='<img src="assets/images/stefano-reiki.jpg?v=1" alt="Stefano Napoleone durante una sessione Reiki in presenza" loading="lazy"><figcaption class="photo-caption">Una sessione Reiki in presenza, in uno spazio tranquillo e rispettoso.</figcaption>';
  ...
  detail.innerHTML='<img src="assets/images/mani-reiki.jpg?v=1" alt="Dettaglio delle mani di Stefano durante un trattamento Reiki" loading="lazy"><figcaption class="photo-caption">Il contatto viene sempre adattato alla sensibilità e alle preferenze della persona.</figcaption>';
